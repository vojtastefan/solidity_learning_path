...
contract DataLocations {
    ...
    function examples(
        ...
        //a new MyStruct is created and stored in the myStructs mapping with the sender's address as the key.
        myStructs[msg.sender] = MyStruct({foo: 123, text: "bar"});  
        
        // Get reference of MyStruct stored in storage.
        MyStruct storage myStruct = myStructs[msg.sender];
        // Edit myStruct = This line modifies the text field of the MyStruct instance.
        myStruct.text = "baz";
